...
class ObjectService
{
    ...
    public static function getMilitaryShipObjects(): array
    {
        ...
        // Only module-registered ships are appended here; core military ships
        // are already returned by MilitaryShipObjects::get(). Iterating all
        // objects would duplicate the core civil ships in getCivilShipObjects().
        foreach (app(ExtensionRegistry::class)->objects() as $object) {
